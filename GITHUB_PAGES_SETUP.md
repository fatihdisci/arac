...
- Repo: `github.com/fatihdisci/arac`
...
1. GitHub'da repo sayfasına git: `github.com/fatihdisci/arac`
...
- Settings → Pages altında şu URL görünür olacak:
  `https://fatihdisci.github.io/arac/`
...
| Sayfa | URL |
|---|---|
| Ana sayfa | `https://fatihdisci.github.io/arac/` |
| Gizlilik Politikası | `https://fatihdisci.github.io/arac/privacy.html` |
| Kullanım Koşulları | `https://fatihdisci.github.io/arac/terms.html` |

### 4. App Store Connect'te Kullan

App Store Connect → App Privacy bölümünde:

- **Privacy Policy URL:** `https://fatihdisci.github.io/arac/privacy.html`
- **Terms of Service URL (opsiyonel):** `https://fatihdisci.github.io/arac/terms.html`
